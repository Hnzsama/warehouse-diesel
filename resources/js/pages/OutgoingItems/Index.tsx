...
import { AlertTriangle, ArrowUpRight, CheckCircle2, Clock, FileSpreadsheet, FileText, Filter, History, Image as ImageIcon, Plus, Printer, Search, Trash2, User as UserIcon } from 'lucide-react';
...
export default function OutgoingItemsIndex({ outgoingItems, items, suppliers = [], users = [], filters }: OutgoingItemsIndexProps) {
    ...
    const handleDelete = (tx: OutgoingItem) => {
        setConfirmState({
            ...
            description: `Apakah Anda yakin ingin menghapus transaksi barang keluar "${tx.reference_no}"? Stok barang akan dikembalikan (ditambahkan) secara otomatis.`,
